...
EW_DEFINE_FIELDS( CoreCursorHit, XObject )
  ...
  /* The variable 'Offset' stores an optional displacement if the user has touched 
     ...
     a small GUI component with a thick finger. This offset value determines the 
     number of pixel to correct all cursor coordinates delivered in the following 
