...
EW_DEFINE_FIELDS( CoreCursorGrabEvent, CoreEvent )
  /* The variable 'Target' refers to the view, which acts as the target in the grab 
     cycle. */
  ...
  /* The variable 'AutoDeflected' is 'true', if the event has been sent from the 
     ...
     view. In this manner new target view is determined. The variables allows you 
     to detect the reason of the event. */
