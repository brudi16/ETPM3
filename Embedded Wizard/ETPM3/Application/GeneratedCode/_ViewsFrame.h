...
EW_DEFINE_FIELDS( ViewsFrame, CoreRectView )
  ...
  /* The property 'Bitmap' refers to the bitmap object to display in this view. 
     ...
     you have to take in account when designing them is, that their size have to 
     be a multiple of 3. */
  ...
  /* The property 'Edges' determines which edges of the frame should be drawn and 
  ...
  /* The property 'NoEdgesLimit' determines the maximum size of the view up to which 
     the edges deactivated explicitly in the property @Edges are not displayed. 
     For example, if you disable in the property @Edges the 'Right' edge and you 
     configure the property 'NoEdgesLimit' to the value <200,0>, the right edge 
     will be invisible as long as the view is narrower than the specified width 
     200. Starting with 200 pixel width, the view displays again the right edge 
     although it is deactivated in the @Edges property.
     The size constraints can be configured individually for the width and height 
     of the view. If the corresponding value is 0 (zero), no limitation is applied. 
     The property is typically useful to display resizable vertical/horizontal gauge 
     bars. */
