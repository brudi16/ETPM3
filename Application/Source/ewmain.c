 ...
 * https://doc.embedded-wizard.de/main-loop
 *
 * @return 1, if further processing is needed, 0 otherwise.
 *
 *****************************************************************************/
int EwProcess( void )
{
 ...
 *
 * @param aViewPort    - Viewport used for the screen update.
 * @param aApplication - Root object used for the screen update.
 *
 *****************************************************************************/
static void EwUpdate( XViewport* aViewport, CoreRoot aApplication )
{
 ...
 *
 * @return Returns the next EmWi key code or CoreKeyCodeNoKey if no key code available.
 *
 *****************************************************************************/
static XEnum EwGetKeyCommand( void )
{
