...
#ifndef _ApplicationWelcomeScreen_H
#define _ApplicationWelcomeScreen_H
...
/* Forward declaration of the class Application::WelcomeScreen */
#ifndef _ApplicationWelcomeScreen_
  EW_DECLARE_CLASS( ApplicationWelcomeScreen )
#define _ApplicationWelcomeScreen_
#endif
...
/* Deklaration of class : 'Application::WelcomeScreen' */
EW_DEFINE_FIELDS( ApplicationWelcomeScreen, CoreGroup )
  EW_OBJECT  ( Rectangle,       ViewsRectangle )
  EW_OBJECT  ( Image,           ViewsImage )
  EW_OBJECT  ( SimpleTouchHandler, CoreSimpleTouchHandler )
EW_END_OF_FIELDS( ApplicationWelcomeScreen )

/* Virtual Method Table (VMT) for the class : 'Application::WelcomeScreen' */
EW_DEFINE_METHODS( ApplicationWelcomeScreen, CoreGroup )
...
EW_END_OF_METHODS( ApplicationWelcomeScreen )
...
#endif /* _ApplicationWelcomeScreen_H */
