...
#ifndef _ApplicationCurrentMeasurement_H
#define _ApplicationCurrentMeasurement_H
...
/* Forward declaration of the class Application::CurrentMeasurement */
#ifndef _ApplicationCurrentMeasurement_
  EW_DECLARE_CLASS( ApplicationCurrentMeasurement )
#define _ApplicationCurrentMeasurement_
#endif
...
/* Deklaration of class : 'Application::CurrentMeasurement' */
EW_DEFINE_FIELDS( ApplicationCurrentMeasurement, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationCurrentMeasurement )

/* Virtual Method Table (VMT) for the class : 'Application::CurrentMeasurement' */
EW_DEFINE_METHODS( ApplicationCurrentMeasurement, CoreGroup )
...
EW_END_OF_METHODS( ApplicationCurrentMeasurement )
...
#endif /* _ApplicationCurrentMeasurement_H */
