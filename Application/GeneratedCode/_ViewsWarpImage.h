...
EW_DEFINE_FIELDS( ViewsWarpImage, ViewsWarpView )
  ...
  /* The property 'Bitmap' refers to the bitmap object to display in this view. 
     ...
     Depending on the property @SourceArea the entire bitmap or only its section 
     is shown. */
  ...
  /* The property 'Color' controls the color of the entire view. Thus this property 
     ...
     be modulated by the values specified in the properties @Color1, @Color2, @Color3 
     and @Color4.
     The effect of this color value depends on the type of the bitmap displayed 
     in this view:
