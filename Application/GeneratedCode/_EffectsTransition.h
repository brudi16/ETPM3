...
EW_DEFINE_METHODS( EffectsTransition, XObject )
  /* The method CreatePresentFader() creates an object of one of the classes descending 
     ...
     to the caller. Typically, the created fader is used to show (to present) a 
     GUI component when the user navigates to it. The method has to be overridden 
  ...
  /* The method CreateDismissFader() creates an object of one of the classes descending 
     ...
     to the caller. Typically, the created fader is used to hide (to dismiss) a 
     GUI component when the user leaves it while he/she navigates in the GUI system. 
     The method has to be overridden and implemented in derived classes. The actual 
  ...
  /* The method CreateRestoreFader() creates an object of one of the classes descending 
     ...
     by other GUI components during the user navigates in the GUI system. The method 
     has to be overridden and implemented in derived classes. The actual implementation 
