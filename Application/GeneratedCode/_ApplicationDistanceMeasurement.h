...
#ifndef _ApplicationDistanceMeasurement_H
#define _ApplicationDistanceMeasurement_H
...
/* Forward declaration of the class Application::DistanceMeasurement */
#ifndef _ApplicationDistanceMeasurement_
  EW_DECLARE_CLASS( ApplicationDistanceMeasurement )
#define _ApplicationDistanceMeasurement_
#endif
...
/* Deklaration of class : 'Application::DistanceMeasurement' */
EW_DEFINE_FIELDS( ApplicationDistanceMeasurement, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationDistanceMeasurement )

/* Virtual Method Table (VMT) for the class : 'Application::DistanceMeasurement' */
EW_DEFINE_METHODS( ApplicationDistanceMeasurement, CoreGroup )
...
EW_END_OF_METHODS( ApplicationDistanceMeasurement )
...
#endif /* _ApplicationDistanceMeasurement_H */
