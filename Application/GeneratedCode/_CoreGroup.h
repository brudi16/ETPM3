...
EW_DEFINE_FIELDS( CoreGroup, CoreRectView )
  ...
  /* The property 'Focus' selects the view to which the component should forward 
     ...
     current keyboard event receiver view. In this context all views along this 
     focus path are 'focused' and able to react to keyboard events.
  ...
  /* The property 'Opacity' controls the translucence of the component. This property 
     can take values in range of 0 .. 255. If the value is 255, the component will 
     appear with its full opacity. The value equal to zero results in a fully transparent 
     component. Other values in the range 1 .. 254 show a semitransparent component. */
