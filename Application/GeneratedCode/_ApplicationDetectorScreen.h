...
#ifndef _ApplicationDetectorScreen_H
#define _ApplicationDetectorScreen_H
...
/* Forward declaration of the class Application::DetectorScreen */
#ifndef _ApplicationDetectorScreen_
  EW_DECLARE_CLASS( ApplicationDetectorScreen )
#define _ApplicationDetectorScreen_
#endif
...
EW_END_OF_FIELDS( ApplicationDetectorScreen )

/* Virtual Method Table (VMT) for the class : 'Application::DetectorScreen' */
EW_DEFINE_METHODS( ApplicationDetectorScreen, CoreGroup )
...
EW_END_OF_METHODS( ApplicationDetectorScreen )
...
#endif /* _ApplicationDetectorScreen_H */
