...
EW_DEFINE_FIELDS( WidgetSetHorizontalValueBar, CoreGroup )
  ...
  /* The property 'Appearance' refers to a 'Horizontal Value Bar Config' object 
     containing bitmaps, colors and further configuration attributes to customize 
     this widget. By assigning a configuration object to the property 'Appearance', 
     the widget automatically assumes the look and feel as determined in the properties 
     ...
     Please note, configuration objects can be shared among multiple value bar widgets. 
