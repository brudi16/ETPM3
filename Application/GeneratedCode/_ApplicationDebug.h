...
#ifndef _ApplicationDebug_H
#define _ApplicationDebug_H
...
/* Forward declaration of the class Application::Debug */
#ifndef _ApplicationDebug_
  EW_DECLARE_CLASS( ApplicationDebug )
#define _ApplicationDebug_
#endif
...
/* Deklaration of class : 'Application::Debug' */
EW_DEFINE_FIELDS( ApplicationDebug, CoreGroup )
  ...
  EW_OBJECT  ( ValueDisplay2,   WidgetSetValueDisplay )
  EW_OBJECT  ( ValueDisplay3,   WidgetSetValueDisplay )
EW_END_OF_FIELDS( ApplicationDebug )

/* Virtual Method Table (VMT) for the class : 'Application::Debug' */
EW_DEFINE_METHODS( ApplicationDebug, CoreGroup )
...
EW_END_OF_METHODS( ApplicationDebug )
