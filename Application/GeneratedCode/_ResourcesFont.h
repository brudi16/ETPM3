...
EW_DEFINE_FIELDS( ResourcesFont, CoreResource )
  ...
  /* The property 'Ascent' stores the ascent metric in pixel of the font. This is 
     the area above the base line. The total height of a text row results of the 
     sum of @Ascent and @Descent. */
